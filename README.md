...
| [TextAttack](https://github.com/textattack/textattack) | A Python framework for adversarial attacks, data augmentation, and hard-negative generation to improve robustness. | ![GitHub Badge](https://img.shields.io/github/stars/textattack/textattack.svg?style=flat-square) |
